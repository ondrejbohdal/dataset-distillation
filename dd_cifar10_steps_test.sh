...
python main.py --mode distill_basic --dataset Cifar10 --arch AlexCifarNet --distill_lr 0.001 --distill_steps ${STEPS[SLURM_ARRAY_TASK_ID-1]} --phase test --test_n_nets 200
